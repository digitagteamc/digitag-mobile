...
export default function Splash3() {
  ...
  return (
    <SplashBackground gradientColors={['#000000', '#B01E68']}>
        ...
        <View style={styles.content}>
          <View style={styles.textWrapper}>
            ...
            <Text style={styles.subtitle}>
              Find makeup artists, hair stylists, photographers, editors & more for every occasion.
            </Text>
          </View>

          <GradientButton 
            title="Next" 
            onPress={() => router.push('/onboarding/splash4')} 
...
const styles = StyleSheet.create({
  ...
  activeDot: { width: 24, backgroundColor: '#E01E79' },
