...
export default function Splash2() {
  ...
  return (
    <SplashBackground gradientColors={['#000000', '#1C265C']}>
        ...
        <View style={styles.content}>
          <View style={styles.textWrapper}>
            ...
            <View style={styles.titleContainer}>
              <Text style={styles.title}>Discover Top</Text>
              <Text style={styles.title}>Brands</Text>
            </View>
            <Text style={styles.subtitle}>
              Connect with fashion labels, beauty brands, and lifestyle companies ready to collaboratee.
            </Text>
          </View>

          <GradientButton
            title="Next"
            onPress={() => router.push('/onboarding/splash3')}
...
const styles = StyleSheet.create({
  ...
  activeDot: { width: 24, backgroundColor: '#405BFF' },
