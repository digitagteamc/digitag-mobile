...
const dashboardMockupImg = require('../assets/Brands/brand-commingsoon.png');

export default function BrandComingSoonScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.topGlowContainer} pointerEvents="none">
                <LinearGradient
                    colors={['rgba(26, 140, 255, 0.16)', 'rgba(26, 140, 255, 0.08)', 'transparent']}
                    ...
                    <View style={styles.mainContent}>
                        ...
                        <View style={styles.titleContainer}>
                            ...
                            <Text style={styles.subText}>
                                Something amazing is on the way. We're building the ultimate creator marketing platform for brands.
                            </Text>
                        </View>
...
const styles = StyleSheet.create({
    ...
    mainContent: {
        flex: 1,
        alignItems: 'center',
        paddingHorizontal: 0, // Remove padding to allow bottomContainer to be full width
    ...
    titleContainer: {
        alignItems: 'center',
        marginTop: 8,
        paddingHorizontal: 24, // Add padding back here
    },
    comingSoonText: {
        fontSize: 46,
