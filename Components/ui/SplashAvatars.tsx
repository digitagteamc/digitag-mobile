    ...
    return (
        <View style={{ height: containerHeight }} className="absolute top-0 left-0 w-full z-10" pointerEvents="none">
            ...
            <View style={{ top: isSmall ? '28%' : '32%', left: '15%', transform: [{ scale: avatarScale }] }} className="absolute items-center">
                <Animated.Image style={stImg2} source={require('../../assets/images/2.webp')} className="w-[65px] h-[65px] rounded-full" />
            ...
            <View style={{ top: isSmall ? '12%' : '18%', left: '40%', transform: [{ scale: avatarScale }] }} className="absolute items-center">
                <Animated.Image style={stImg1} source={require('../../assets/images/1.webp')} className="w-[68px] h-[68px] rounded-full" />
            ...
            <View style={{ top: isSmall ? '25%' : '30%', right: '14%', transform: [{ scale: avatarScale }] }} className="absolute items-end">
                <Animated.Image style={stImg3} source={require('../../assets/images/3.webp')} className="w-[75px] h-[75px] rounded-full mr-2" />
            ...
            <View style={{ top: isSmall ? '38%' : '42%', left: '38%', transform: [{ scale: avatarScale }] }} className="absolute items-center">
                <Animated.Image style={stImg4} source={require('../../assets/images/4.webp')} className="w-[75px] h-[75px] rounded-full" />
            ...
            <View style={{ top: isSmall ? '50%' : '58%', left: '12%', transform: [{ scale: avatarScale }] }} className="absolute">
                <Image source={require('../../assets/images/5.webp')} className="w-[110px] h-[110px] rounded-full" />
                <Image source={require('../../assets/images/6.webp')} className="absolute -bottom-8 right-3 w-14 h-14 rounded-full z-20" />
            </View>

            {/* 8.jpg - No text, right middle */}
            <View style={{ top: isSmall ? '54%' : '62%', right: '10%', transform: [{ scale: avatarScale }] }} className="absolute">
                <Animated.Image style={stImg8} source={require('../../assets/images/8.webp')} className="w-[75px] h-[75px] rounded-full" />
            </View>
            ...
            <View style={{ top: isSmall ? '60%' : '68%', left: '45%', transform: [{ scale: avatarScale }] }} className="absolute items-center">
                <Animated.Image style={stImg7} source={require('../../assets/images/7.webp')} className="w-[75px] h-[75px] rounded-full" />
